    ...
    return (
        <div className="px-16">
            <div className="flex flex-row items-center py-4">
                ...
                {!showFields && (
                    <FontAwesomeIcon icon={faSquarePlus} className="text-blue-500 ms-4 text-xl  cursor-pointer" title="Add Notes" onClick={() => setShowFields(true)} />
                )}
            </div>
            {showFields && (
                <>
                    ...
                    <button className="bg-blue-500 text-white px-4 py-2 rounded-md" onClick={handleClick}>Add Note</button>
