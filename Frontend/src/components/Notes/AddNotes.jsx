    ...
    return (
        <div className="px-16">
            <div className="flex flex-row items-center py-4">
                ...
                {!showFields && (
                    <FontAwesomeIcon icon={faSquarePlus} className="ms-4 text-xl  cursor-pointer" title="Add Notes" onClick={() => setShowFields(true)} style={{color:textColor}} />
                )}
            </div>
            {showFields && (
                <>
                    ...
                    <button className=" text-white transition duration-300 ease-in-out transform hover:scale-105 px-4 py-2 rounded-md" onClick={handleClick} style={{backgroundColor:sidenavColor}}>Add Note</button>
