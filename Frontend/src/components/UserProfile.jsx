...
const UserProfile = () => {
  ...
  return (
    <div className="container mx-auto mt-8 max-w-xl bg-gray-100 rounded-lg shadow-md p-8" style={{ fontFamily: paraFont }}>
      <h1 className="text-3xl font-bold mb-4 text-center" style={{ fontFamily: headingFont }}>User Profile</h1>
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="mb-2"><span className="font-semibold" style={{ fontFamily: navbarFont }}>Name:</span> <span style={{ fontFamily: paraFont }}>{userData.name}</span></p>
        <p className="mb-4"><span className="font-semibold" style={{ fontFamily: navbarFont }}>Email:</span> <span style={{ fontFamily: paraFont }}>{userData.email}</span></p>
      </div>
      <div className="flex flex-col items-center">
        <h2 className="text-xl font-semibold mb-2" style={{ fontFamily: headingFont }}>Change Profile Picture:</h2>
