...
/>
                                    ...
                                    <td className="border px-4 py-2">{selectedReport.reportType=="SITREP" && key=="pocScreenshotsScore"?'30':key=="penaltyScore"?'':selectedReport.reportType=="SITREP"?'20':selectedReport.reportType=="IRREP"?'10':key==="penaltyScore"?'':'5'}</td>
                                    <td className="border px-2 py-2">
                                        {
                                            route == "progress" 
                                            ?
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    let inputValue = parseInt(e.target.value);
                                                    if (e.target.value === "" || (!isNaN(inputValue) && inputValue >= 0 && inputValue <= (selectedReport.reportType=="SITREP" && key=="pocScreenshotsScore"?'30':key=="penaltyScore"?'1000':selectedReport.reportType=="SITREP"?'20':selectedReport.reportType=="IRREP"?'10':'5'))) {
                                                        setSelectedReport(prevReport => ({
                                                            ...prevReport,
                                                            [key]: inputValue
                                                        }));
