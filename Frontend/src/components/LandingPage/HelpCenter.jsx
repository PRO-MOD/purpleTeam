...
const HelpCenter = () => {
    return (
        <div className="flex flex-col md:flex-row justify-between h-screen gap-8 p-8">
            {/* Left Section */}
            <div 
            ...
            >
                <div className="absolute top-4 left-4 w-1/2 p-6">
                    <h3 className="text-3xl font-bold mb-4 text-black">Breachpoint Help Center</h3>
            ...
            >
                <div className="absolute top-4 left-4 w-1/2 p-6">
                    <h3 className="text-3xl font-bold mb-4 text-white">Free Consultation and Onboarding Support</h3>
