    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg z-10 w-full max-w-md">
                <h2 className="text-xl font-bold mb-4">Assign Static Score</h2>
                <p className="text-lg font-semibold mb-4">User ID: {userId}</p>
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label htmlFor="staticScore" className="block text-sm font-medium text-gray-700">Static Score</label>
                        <input
                            type="text"
                            id="staticScore"
                            value={staticScore}
