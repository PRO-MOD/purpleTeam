...
//     const fetchProfileImage = async (url, id) => {
//         try {
...
//             setProfileImages((prev) => ({ ...prev, [id]: imageURL }));
//         } catch (error) {
//             console.error('Error fetching profile image:', error);
//             setProfileImages((prev) => ({ ...prev, [id]: "https://cdn-icons-png.flaticon.com/512/3135/3135715.png" }));
//         }
//     };
...
//                 fetchProfileImage(conversation?.recipient?.profile, conversation?.recipient?._id)
//             );
//         } else if (position === 'right') {
//             volunteers.forEach((volunteer) =>
//                 fetchProfileImage(volunteer.profile, volunteer._id)
//             );
//         }
//     }, [conversations, volunteers, position]);
...
//                     avatar={profileImages[conversation?.recipient?._id] || "https://cdn-icons-png.flaticon.com/512/3135/3135715.png"}
...
//                     avatar={profileImages[volunteer._id] || "https://cdn-icons-png.flaticon.com/512/3135/3135715.png"}
//                     alt={volunteer.name}
