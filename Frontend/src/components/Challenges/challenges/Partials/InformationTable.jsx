                    ...
                    <thead className="text-xs" style={{ backgroundColor: sidenavColor }}>
                        <tr>
                            {columns.map((column, index) => (
                                <th key={index} className="py-2 px-4 border-b border-r text-white" style={navbarFont}>
                                    {column.header}
                                </th>
                            ))}
                        </tr>
                        ...
                        {data.map((item, rowIndex) => (
                            ...
                            >
                                {columns.map((column, colIndex) => (
                                    <td
                                        key={colIndex}
                                        className={`py-2 px-4 border-b border-r ${colIndex === columns.length - 1 ? '' : 'border-r'}`}
                                        style={paraFont}
                                    >
